...
@implementation RevanQRCodeScanView
...
- (void)initialization {
    _scanAnimationStyle = RevanScanAnimationStyleDefault;
    _borderColor = [UIColor whiteColor];
    _cornerLocation = RevanCornerLoactionTypeDefault;
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.cornerLocation == RevanCornerLoactionTypeInside) {
    ...
    else if (self.cornerLocation == RevanCornerLoactionTypeOutside) {
...
- (void)addTimer {
    ...
    if (self.scanAnimationStyle == RevanScanAnimationStyleGrid) {
...
- (void)setScanAnimationStyle:(RevanScanAnimationStyle)scanAnimationStyle {
...
- (void)setCornerLocation:(RevanCornerLoactionType)cornerLocation {
...
- (UIImageView *)scanningline {
    if (!_scanningline) {
        ...
        _scanningline.image = [UIImage revan_assetImageName:self.scanningImageName inDirectoryBundleName:@"RevanQRCode" commandClass:[self class]];
    }
